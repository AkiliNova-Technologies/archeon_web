    ...
    return (
      <section
        ...
        style={{
          ...
          padding:
            "clamp(120px, 20vh, 180px) clamp(16px, 5vw, 28px) clamp(80px, 12vh, 120px)",
        }}
      >
        <h1
          style={{
        ...
        <Btn
          href="/projects"
          variant="outline"
          style={{ marginTop: "clamp(20px, 3vw, 24px)" }}
        >
          Back to Projects
        </Btn>
      </section>
    ...
    <>
      <section
        style={{
          background: C.parchment,
          padding:
            "clamp(100px, 15vh, 140px) clamp(16px, 5vw, 28px) clamp(40px, 6vh, 60px)",
        }}
      >
      ...
      <section
        style={{
          padding: "0 clamp(16px, 5vw, 28px) clamp(40px, 6vh, 60px)",
          background: C.parchment,
        }}
      >
      ...
      <section
        style={{
          background: C.cream,
          padding: "clamp(60px, 8vh, 80px) clamp(8px, 2vw, 14px)",
        }}
      >
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: R.xl,
                      padding:
                        "clamp(20px, 3vw, 28px) clamp(16px, 2.5vw, 24px)",
                      boxShadow: "0 2px 12px rgba(30,30,30,0.03)",
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "translateY(-3px)";
                      e.currentTarget.style.boxShadow =
                        "0 8px 24px rgba(30,30,30,0.06)";
                    }}
                    onMouseLeave={(e) => {
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: R.xl,
                      padding:
                        "clamp(24px, 3.5vw, 32px) clamp(20px, 3vw, 28px)",
                      boxShadow: "0 2px 12px rgba(30,30,30,0.03)",
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = "translateY(-3px)";
